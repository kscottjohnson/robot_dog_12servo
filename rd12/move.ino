...
void balanceTest() {
  legs[FRONT_LEFT ].move( 0, 0, 170);
  legs[FRONT_RIGHT].move( 0, 40, 170);
  legs[BACK_LEFT  ].move( 0, 0, 170);
  legs[BACK_RIGHT ].move( 0, 0, 150);
}
...
float sCurrentY[4] = {0,0,0,0}, sCurrentZ[4] = {170,170,170,170};
float    sPrevY[4] = {0,0,0,0},    sPrevZ[4] = {170,170,170,170};
bool sFirstStep = true;
int8_t sDirection = 1; // 1 forward, -1 reverse
uint8_t sLegSpeed = 5; // multiplier for leg movement
